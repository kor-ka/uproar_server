...
class BotActor(pykka.ThreadingActor):
    ...
    def on_start(self):
        ...
        self.bot.delete_message(1001131441239, 13401)
        self.bot.delete_message(1001131441239, 13402)
        self.bot.delete_message(1001131441239, 13403)
        self.bot.delete_message(1001131441239, 13404)
        self.bot.delete_message(1001131441239, 13405)
        self.bot.delete_message(1001131441239, 13406)
        self.bot.delete_message(1001131441239, 13407)
        self.bot.delete_message(1001131441239, 13408)
        self.bot.delete_message(1001131441239, 13409)
        self.bot.delete_message(1001131441239, 13410)
        self.bot.delete_message(1001131441239, 13411)
        self.bot.delete_message(1001131441239, 13412)
        self.bot.delete_message(1001131441239, 13413)
        self.bot.delete_message(1001131441239, 13414)
        self.bot.delete_message(1001131441239, 13415)
        self.bot.delete_message(1001131441239, 13416)
        self.bot.delete_message(1001131441239, 13417)
        self.bot.delete_message(1001131441239, 13418)
        self.bot.delete_message(1001131441239, 13419)
